...
<li>
  <div class="col-sm-9" style="position: relative;padding-right: 15px;">
    <div class="title"><a href="https://arxiv.org/pdf/2506.23034">Guiding AI to Fix Its Own Flaws: An Empirical Study on LLM-Driven Secure Code Generation</a></div>
    <div class="author"><strong>Hao Yan</strong>, Swapneel Suhas Vaidya, Xiaokuan Zhang, Ziyu Yao</div>
    <div class="periodical"><em>ACM Transactions on Software Engineering and Methodology (TOSEM), 2026</em></div>
    <div class="links">
      <a href="https://arxiv.org/pdf/2506.23034" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
    </div>
  </div>
</li>
<li>
  <div class="col-sm-9" style="position: relative;padding-right: 15px;">
    ...
    <div class="periodical"><em>COLM 2025 Workshop on Social Simulation with LLMs</em></div>
    <div class="links">
