...
I am a Ph.D. candidate in the [Department of Computer Science](https://cs.gmu.edu) and [GMU NLP Group](https://nlp.cs.gmu.edu/) at George Mason University, advised by [Dr. Ziyu Yao](https://ziyuyao.org/), where I work on making **Large Language Models safe, trustworthy, and usable for everyone**. My research weaves together four threads:

1. **🛡️ AI Safety & Secure Code Generation** — I led one of the first large-scale empirical studies of LLM-driven secure code generation, showing how models can be guided to find and fix their own vulnerabilities (*ACM TOSEM*).
2. **🔬 Interpretability & Explainability** — Most recently, I have been looking under the hood: interpreting the internal mechanisms of LLMs and explaining their behavior to make generations safer and more reliable (*EMNLP 2026*).
...
- LLM Safety & Secure Code Generation
- LLM Interpretability & Explainability
- LLM Reasoning & Agentic AI
- Human-AI Interaction & Conversational Code Generation
